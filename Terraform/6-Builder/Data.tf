...
data "terraform_remote_state" "vpc" {
  ...
  config = {
    ...
    key    = "RemoteState/Projeto20/vpc/terraform.tfstate"
...
data "terraform_remote_state" "orquestrador" {
  ...
  config = {
    bucket = "crfjunior-remote-state"
    key    = "RemoteState/Projeto20/Orquestrador/terraform.tfstate"
    #key    = "RemoteState/vpc/terraform.tfstate"
    #bucket = "terraform-state-prod"
    #key    = "network/terraform.tfstate"
    region = "us-east-1"
...
data "terraform_remote_state" "efs" {
  ...
  config = {
    bucket = "crfjunior-remote-state"
    key    = "RemoteState/Projeto20/EFS/terraform.tfstate"
    #key    = "RemoteState/vpc/terraform.tfstate"
    #bucket = "terraform-state-prod"
    #key    = "network/terraform.tfstate"
    region = "us-east-1"
...
data "terraform_remote_state" "ecr" {
  ...
  config = {
    bucket = "crfjunior-remote-state"
    key    = "RemoteState/Projeto20/ECR/terraform.tfstate"
    #key    = "RemoteState/vpc/terraform.tfstate"
    #bucket = "terraform-state-prod"
    #key    = "network/terraform.tfstate"
    region = "us-east-1"
